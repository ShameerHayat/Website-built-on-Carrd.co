	...
	// Slideshow: slideshow01.
		(function() {
			...
			new slideshowBackground('slideshow01', {
				...
				images: [
					{
						src: 'assets/images/slideshow01-931182cd.jpg',
						position: 'center',
						motion: 'left',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-3ea9d44a.jpg',
						position: 'center',
						motion: 'left',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-c539614e.jpg',
						position: 'center',
						motion: 'left',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-c59ffa89.jpg',
						position: 'center',
						motion: 'left',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-6486cb5b.jpg',
						position: 'center',
						motion: 'left',
						speed: 2,
						caption: 'Untitled',
					...
					{
						src: 'assets/images/slideshow01-3a680cb4.jpg',
						position: 'center',
						motion: 'left',
						speed: 2,
						caption: 'Untitled',
